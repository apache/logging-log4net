	...
	public class XmlHierarchyConfigurator
	{
		...
		protected void SetParameter(XmlElement element, object target) 
		{
			...
			else
			{
				...
				if(propertyValue != null)
				{
#if !(NETCF || NETSTANDARD) // NETSTANDARD: System.Runtime.InteropServices.RuntimeInformation not available on desktop 4.6
					try
					{
...
#if NETSTANDARD // TODO BindingFlags is available for netstandard1.5
