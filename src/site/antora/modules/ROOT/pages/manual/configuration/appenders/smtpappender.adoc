...
|`log4net.Appender.SmtpAppender` (legacy)
|`log4net`
...
[#legacy-smtpappender]
== Built-in SmtpAppender (legacy)

[NOTE]
====
This appender is still shipped and still works, but it is not recommended for new configurations.
